...
\texttt{DerivationTree Γ φ} (written $\context \proves \varphi$) is an inductive type
...
Notation & Lean \\
\midrule
$\context \proves \varphi$ & \texttt{DerivationTree Γ φ} \\
$\proves \varphi$ & \texttt{DerivationTree [] φ} \\
\bottomrule
\end{tabular}
\end{center}
