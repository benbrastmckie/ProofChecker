...
Standards (5 files):
  documentation-standards.md, lean-style.md, lean4-style-guide.md, 
...
```
documentation-standards.md, state-schema.md, status-markers.md
```
...
**Documentation**:
- Load: `core/standards/docs.md`, `lean4/standards/documentation-standards.md`
