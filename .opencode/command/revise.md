...
routing:
  ...
  plan_revision_command: planner-agent
  task_update_command: task-expander
context_loading:
  strategy: lazy
  ...
  <stage id="1" name="ParseAndValidate">
    ...
    <process>
      1. Parse task number and optional reason from $ARGUMENTS
         ...
         - If invalid: Return error "Usage: /revise <task_number> [REASON]"
      ...
      5. Check for existing implementation plan
         - Find latest plan: `specs/{N}_{SLUG}/plans/implementation-{LATEST}.md`
         - If plan exists:
              plan_exists=true
