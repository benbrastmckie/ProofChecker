---
description: "Interactive builder that creates complete context-aware AI architectures tailored to user domains"
---

<target_domain> $ARGUMENTS </target_domain>

<context>
  <system_context>AI-powered context-aware builder using hierarchical agent patterns, XML optimization, and research-backed architecture</system_context>
  ...
  <stage id="0" name="DetectExistingProject">
    ...
    <detection_logic>
      ...
      <identify_capabilities>
        ...
        - coder: Code analysis, file operations
  ...
  <stage id="2.5" name="DetectDomainType">
    ...
    <existing_agent_matching>
      <for_development>
        ...
        - coder: Code analysis and file operations
