...
**Usage**:
1. Copy `command-template.md` to `.opencode/command/<command-name>.md`
...
- Agent file must exist in `.opencode/agents/`
...
1. Load `.opencode/context/index.md` first
...
- **Migration Guide**: `.opencode/docs/migrations/001-openagents-migration/README.md`
