...
- `.opencode/context/core/standards/status-markers.md` - Complete status definitions
- `.opencode/context/core/patterns/inline-status-update.md` - jq patterns for direct updates
