...
2. **Planning**: `/plan` - Create detailed implementation plans
3. **Implementation**: `/lean` - Implement proofs with lean-lsp-mcp verification
...
See [.opencode/README.md](../../README.md) for AI system details.
...
/lean <proof>                # Implement LEAN 4 proof
...
- [.opencode/ARCHITECTURE.md](../../ARCHITECTURE.md) - Agent system architecture
- [.opencode/QUICK-START.md](../../QUICK-START.md) - AI workflow guide
