...
**Stage 6 (CreateTasks)**: Create .opencode/specs/TODO.md tasks from identified_tasks, map placeholder numbers to actual numbers
...
Review summaries follow @.opencode/context/core/formats/summary-format.md:
