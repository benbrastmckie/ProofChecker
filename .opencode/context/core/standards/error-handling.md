...
2. Check if the file exists: ls -la .opencode/specs/
3. Create the file if needed: touch .opencode/specs/TODO.md
```
...
- `.opencode/agent/subagents/lean/proof-planner.md` - Subagent error handling
