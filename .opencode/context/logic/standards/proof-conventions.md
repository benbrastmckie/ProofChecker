...
This document defines proof style conventions for modal and temporal logic in the ProofChecker LEAN 4 codebase. These conventions ensure consistency, readability, and maintainability across proofs.
