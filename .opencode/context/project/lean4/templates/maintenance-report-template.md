...
1. **{NNN_project_name}** (Completed: {YYYY-MM-DD})
   ...
   - **Archive Path**: `.opencode/specs/archive/{NNN_project_name}/`
...
### 4.1 Archive State
- **Updated**: `.opencode/specs/archive/state.json`
- **Projects Added**: {N}
- **Total Archived**: {N} projects

### 4.2 Maintenance State
- **Updated**: `.opencode/specs/maintenance/state.json`
- **Operation ID**: `maintenance-{YYYYMMDD}`
- **Health Trend**: {Improving | Stable | Declining}

### 4.3 Global State
- **Updated**: `.opencode/specs/state.json`
