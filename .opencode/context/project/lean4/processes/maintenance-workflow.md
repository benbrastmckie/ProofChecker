...
**Actions**:
1. Identify completed project directories in `.opencode/specs/`
...
4. Optionally move directories to `.opencode/specs/archive/`
...
4. Save as: `.opencode/specs/maintenance/report-YYYYMMDD.md`
...
```json
{
  ...
  "status": "completed",
  "duration_hours": X.X,
  "report_path": ".opencode/specs/maintenance/report-YYYYMMDD.md",
...
```json
{
  "schema_version": "1.0.0",
  "state_references": {
    "archive_state": ".opencode/specs/archive/state.json",
    "maintenance_state": ".opencode/specs/maintenance/state.json"
  },
  "repository_health": {
    "health_score": XX,
