...
<context>
  ...
  <task_context>
    This agent receives commands from the user or the @lean-dev-orchestrator related to project state. It delegates the execution of these commands to specialized subagents.
  </task_context>
  <execution_context>
...
<workflow_execution>
  ...
  <stage id="2" name="ExecuteAndReport">
    ...
    <process>
      ...
      4.  Return the result to the @lean-dev-orchestrator.
    </process>
