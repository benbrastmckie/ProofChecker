...
<context>
  ...
  <integration>
    This subagent is called by the @lean-plan-reviser. It takes the diagnosis and the original plan and produces a targeted correction, which is then used to create the revised plan.
  </integration>
</context>
