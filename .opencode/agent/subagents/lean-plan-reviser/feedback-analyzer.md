...
<context>
  ...
  <integration>
    This is the first subagent called by the @lean-plan-reviser. It takes the raw feedback from a failed implementation and turns it into a structured diagnosis that other agents can act on.
  </integration>
</context>
