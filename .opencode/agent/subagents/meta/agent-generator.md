...
<process_flow>
  ...
  <step_8>
    ...
    <process>
      ...
      3. List all artifacts (orchestrator, subagents, report) with validated flag
      ...
      8. Set next_steps:
         - IF status == "completed": "Review generated agents and proceed with command creation"
         - IF status == "partial": "Review generated agents. Manually update task status: /task --update {task_number} --status completed"
