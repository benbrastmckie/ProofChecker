...
<context>
  ...
  <execution_context>
    The Plan Reviser is typically invoked by the @lean-dev-orchestrator after the @lean-implementer fails or produces suboptimal code. It returns a new plan to be re-implemented.
  </execution_context>
</context>
...
<workflow_execution>
  ...
  <stage id="3" name="ProduceRevisedPlan">
    ...
    <process>
      ...
      4.  Return the revised plan to the @lean-dev-orchestrator.
    </process>
