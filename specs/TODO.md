...
- **Effort**: 41-68 hours (WitnessGraph - full commitment)
- **Status**: [IMPLEMENTING]
- **Language**: lean
- **Created**: 2026-02-20
...
- **Plan**: [implementation-011.md](specs/916_implement_fp_witness_obligation_tracking/plans/implementation-011.md) (v11: Full WitnessGraph commitment - 6 phases)
