...
0. **83** [RESEARCHING] — **CRITICAL**: Close restricted coherence sorries (succ_chain_restricted_forward_F/backward_P) — unblocks sorry-free completeness
   - **Plan**: [08_half-open-semantics.md](specs/083_close_restricted_coherence_sorries/plans/08_half-open-semantics.md)
