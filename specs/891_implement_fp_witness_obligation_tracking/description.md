# Task 891: Implement F/P witness obligation tracking to close DovetailingChain sorries
...
## Dependencies
- Task 889 (rename, for consistency — but can proceed in parallel)
- Task 890 (documentation, for reference — but can proceed in parallel)
