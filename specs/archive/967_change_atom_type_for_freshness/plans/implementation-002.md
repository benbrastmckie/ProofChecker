...
**Scope**: This is a deep refactor affecting core semantics, requiring cascading proof fixes throughout the metalogic. The user has explicitly requested proceeding with this approach despite prior ROAD_MAP.md warnings.
...
### Expected Resolution
- Phase 7 completes the Gabbay IRR proof using T-axiom, eliminating both sorries
- Phase 8 replaces the axiom with a theorem
...
### Expected Resolution
- Phase 7-8: Complete Gabbay IRR proof using T-axiom
...
- [ ] Update comments referencing "strictly past/future" to "now and past/future"
...
**Files to modify:**
- `Theories/Bimodal/Semantics/Truth.lean` - lines 118-119, docstrings

**Verification:**
- `lake build Theories/Bimodal/Semantics/Truth.lean` compiles (module-level)
- Comments accurately reflect new semantics
...
### Phase 7: Complete Gabbay IRR Proof [NOT STARTED]
...
**Tasks:**
- [ ] Read CanonicalIrreflexivity.lean to understand current proof structure
...
### Phase 8: Replace Axiom with Theorem [NOT STARTED]
...
### Phase 9: Cascading Proof Fixes [NOT STARTED]
...
- [ ] Update documentation references to irreflexive semantics
- [ ] Update ROAD_MAP.md to mark this approach as successful
...
- `ROAD_MAP.md` - update Dead End entry status
...
- `specs/967_change_atom_type_for_freshness/plans/implementation-002.md` (this file)
