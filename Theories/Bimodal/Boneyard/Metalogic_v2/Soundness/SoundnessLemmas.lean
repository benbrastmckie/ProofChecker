...
/-!
# Soundness Lemmas - Bridge Theorems for Temporal Duality (Metalogic_v2)
...
namespace Bimodal.Metalogic_v2.Soundness.SoundnessLemmas
...
end Bimodal.Metalogic_v2.Soundness.SoundnessLemmas
