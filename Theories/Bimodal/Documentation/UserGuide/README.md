...
| [PROOF_PATTERNS.md](PROOF_PATTERNS.md) | Common patterns for modal and temporal reasoning |

## Reading Order

1. **First**: [QUICKSTART.md](QUICKSTART.md) - Basics of writing Bimodal proofs
2. **Next**: [PROOF_PATTERNS.md](PROOF_PATTERNS.md) - Patterns for different proof types
