...
The time-shift operation translates a history by a temporal offset, making it possible to relate truth at different times.
...
% TODO: use the notation used in def:time-shift-histories
