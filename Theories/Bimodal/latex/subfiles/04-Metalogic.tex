...
This is proven as \texttt{semantic\_weak\_completeness}.
\end{theorem}

\begin{theorem}[Strong Completeness]
If $\context \satisfies \varphi$ then $\context \proves \varphi$.
This is proven as \texttt{main\_strong\_completeness} with bridge sorries for the general valid connection.
\end{theorem}
