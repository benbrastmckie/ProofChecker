...
The \emph{Representation Theorem} provides the fundamental bridge between syntactic consistency and semantic satisfiability.
...
The \emph{Finite Model Property} connects the representation infrastructure to decidability.
