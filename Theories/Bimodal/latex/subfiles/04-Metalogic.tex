...
% FIX: I want 'Representation Theorem' and other names of theorems to be in italics
...
% FIX: I don't need the 'Corollaries', 'Central Result', and 'Core Infrastructure' labels since instead it would be better to explain this following the diagram
