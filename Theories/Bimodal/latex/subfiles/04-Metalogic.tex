...
% TODO: This is confusing since it should introduce how histories and times are constructed FIRST, and then use these to define canonical world states. In general, no definition should be stated in terms of definitions not yet given.
...
If $\context \valid \varphi$ then $\context \proves \varphi$.\footnote{This is proven as \texttt{main\_strong\_completeness} with bridge sorries for the generalization.}
\end{theorem}
