...
The paper uses a fixed temporal type $T = \mathbb{Z}$ (integers).
The implementation generalizes to any type $T$ with \texttt{LinearOrderedAddCommGroup} instance, allowing for integers, rationals, reals, or custom bounded time structures.
