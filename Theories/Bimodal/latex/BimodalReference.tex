...
\begin{abstract}
\noindent
This reference manual provides the formal specification of the Bimodal logic \textbf{TM} for tense and modality as implemented in the \href{https://github.com/benbrastmckie/ProofChecker}{\texttt{ProofChecker}} project.
...
The soundness theorem has been established along with the deduction theorem.
Completeness infrastructure is in place but the core lemmas remain axiomatized,
requiring further work to derive these lemmas.
\end{abstract}
