...
Logos is a hyperintensional modal-temporal logic with exact truthmaker semantics, designed for reasoning about necessity, possibility, time, and counterfactual conditionals.
The semantics extends from a mereological state space foundation through increasingly expressive extensions.
\end{abstract}
