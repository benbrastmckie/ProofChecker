...
This semantics and its corresponding proof theory is successively extended to support a wide range of additional operators for complex reasoning to plan and evaluate actions in multi-agent systems under conditions of uncertainty.
\end{abstract}
