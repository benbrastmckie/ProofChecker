...
\[
	t \Define v \mid c \mid f(t_1, \ldots, t_n)
\]
where $v$ ranges over variables, $c$ over individual constants (0-place function symbols), and $f$ over $n$-place function symbols.
