...
\midrule
$\waspast(\mathsf{I}(\varphi))$ & ``I previously believed $\varphi$'' \\
$\mathsf{I}(\waspast(\varphi))$ & ``I believe $\varphi$ was the case'' \\
$\willfuture(\mathsf{I}(\varphi))$ & ``I will believe $\varphi$'' \\
$\mathsf{I}(\willfuture(\varphi))$ & ``I believe $\varphi$ will be the case'' \\
\bottomrule
\end{tabular}
\end{center}

\begin{remark}[Non-Equivalence]
The pairs $\waspast(\mathsf{I}(\varphi))$ and $\mathsf{I}(\waspast(\varphi))$ are not equivalent.
