...
The \textit{Dynamical Foundation} extends state frames to include a \textit{task relation} parameterized by durations belonging to a \textit{temporal order} that govern the lawful transitions by which a system and its parts evolve.
