...
The semantics proceeds through increasingly expressive extensions,
each extending the frame and evaluation mechanisms of the previous.
...
\begin{enumerate}
  ...
  \item \textbf{Explanatory Extension}: Hyperintensional and intensional semantics over a task space.
        Extends the foundation with temporal structure (a totally ordered abelian group) and a task relation constraining possible state transitions,
