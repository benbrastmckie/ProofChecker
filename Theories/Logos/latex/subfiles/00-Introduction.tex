...
\begin{enumerate}
	...
	\item \textbf{Social Extension}:
	      Provides resources for common ground construction and group-level reasoning, building upon the \textit{Agential Extension} to enable reasoning about shared beliefs, build trust in other agents, and coordinate on common goals.
