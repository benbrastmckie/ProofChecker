...
Whereas the \textit{Constitutive Foundation} and \textit{Dynamical Foundation} form the required base, the middle extensions (Epistemic, Abilities, Normative, Choice, Spatial, and others) are modular plugins that can be combined in any subset.
