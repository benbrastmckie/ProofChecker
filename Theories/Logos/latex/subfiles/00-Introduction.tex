...
\node[smallbox, left=0.5cm of normative] (epistemic) {
  \begin{tabular}{c}
    \textbf{Epistemic} \\
...
\node[smallbox, right=0.5cm of normative] (abilities) {
  \begin{tabular}{c}
    \textbf{Abilities} \\
...
\node[draw=none, right=0.3cm of abilities, font=\Large] (rightellipsis) {$\cdots$};
