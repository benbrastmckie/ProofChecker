...
\begin{description}
	...
	\item[\Cref{sec:dynamical-foundation}] introduces the syntactic primitives of the Explanatory Extension, including modal, temporal, and counterfactual operators.
