...
The Spatial Extension extends the Explanatory Extension with structures for spatial reasoning
and location.
...
\begin{question}
What spatial primitives are required?
Should locations be mereological (with parts) or set-theoretic?
\end{question}
