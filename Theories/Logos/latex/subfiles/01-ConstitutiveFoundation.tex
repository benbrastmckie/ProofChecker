...
\begin{remark}\label{rem:trivial-cases}
	...
	\begin{itemize}
		\item \textbf{Constant symbols} $\interp{c} : (\Fin\;0 \to \statespace) \to \statespace \cong \statespace$.
...
\begin{remark}[Identity and Contingency]
	...
	The \textit{Dynamical Foundation} encodes these contingencies by evaluating sentences at world-histories and times in addition to a model and variable assignment.
\end{remark}
