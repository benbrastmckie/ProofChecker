...
\begin{definition}\label{def:constitutive-model}
	...
	\begin{itemize}
		...
		\item \textbf{n-place predicates} $\interp{F} = \langle \verifierset{F}, \falsifierset{F} \rangle$ where:
		      \begin{itemize}
			      \item $\Fusion(a_1, \ldots, a_n) \sqsubseteq f^+(a_1, \ldots, a_n)$ for any $f^+ : \verifierset{F}$ and $a_1, \ldots, a_n : \statespace$.
			      \item $\Fusion(a_1, \ldots, a_n) \sqsubseteq f^-(a_1, \ldots, a_n)$ for any $f^- : \falsifierset{F}$ and $a_1, \ldots, a_n : \statespace$.
		      \end{itemize}
		\item \textbf{Sentence letters} $\interp{p} = \langle \verifierset{p}, \falsifierset{p} \rangle$ of verifier and falsifier state sets
	\end{itemize}
\end{definition}
