...
% TODO: what about using $\verifiertype{F} : (\Fin\;n \to \statespace) \to \statespace \to Prop$ instead? Is this the more dependent type theory native way to define things? It is important that \falsifiertype{F} be defined similarly where these may then have different extensions
