...
% FIX: the remark below should be used instead to improve the definition above of a world-state in def:state-modality which is currently stated in terms of 'maximal' which is not defined and then combined to define world-states
