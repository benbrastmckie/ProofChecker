...
| `Conservativity.lean` | 354 | `Conservativity/` |
| `Core.lean` | 37 | `Core/` |
...
|----------------------|------:|------|
| `Conservativity.lean` | 354 | Conservativity of the extension |
...
| [`Conservativity/`](Conservativity/README.md) | 13 | 2,973 | Conservativity of TM⁺ over the base language BL: the translation, the backward direction, and the CEB/CEF/CED/CEC status record |
