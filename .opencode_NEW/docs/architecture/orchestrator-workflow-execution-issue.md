...
Command files (e.g., `.opencode/command/implement.md`) have comprehensive 4-stage workflow patterns:
...
The orchestrator:
1. Loads command file from `.opencode/command/{command}.md`
...
- Command files: `.opencode/command/implement.md`, `.opencode/command/research.md`, etc.
- Subagents: `.opencode/agent/subagents/implementer.md`, `.opencode/agent/subagents/researcher.md`, etc.
