...
3. **Orchestrator Routing**: Orchestrator reads frontmatter and delegates
   ...
   - Load agent file from `.opencode/agents/{agent}.md`
...
4. **Agent Specification**: Agents specified by name
   ...
   - `reviser` → `.opencode/agents/reviser.md`
...
- `agent` (required): Name of agent to handle this command
  ...
  - Example: `research-agent` → `.opencode/agents/research-agent.md`
...
- **Migration Guide**: `.opencode/docs/migrations/001-openagents-migration/phase-2-guide.md`
