...
- Updated `docs/user-guide/EXAMPLES.md` to highlight `Logos/Examples` as canonical and refreshed solution links.
...
- Documentation update: `docs/user-guide/EXAMPLES.md`
