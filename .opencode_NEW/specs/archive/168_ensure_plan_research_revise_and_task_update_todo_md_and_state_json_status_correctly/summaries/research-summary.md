...
- `.opencode/context/core/standards/status-markers.md`: Defines status marker standards and timestamp formats
...
See: `specs/168_ensure_plan_research_revise_and_task_update_todo_md_and_state_json_status_correctly/reports/research-001.md`
