...
**Reference**: See @.claude/skills/skill-lean-version/SKILL.md for full upgrade procedure.
...
**Reference**: See @.claude/skills/skill-lean-version/SKILL.md for full rollback procedure.
...
**For detailed procedures** (backup management, version detection, error handling):
See @.claude/skills/skill-lean-version/SKILL.md
