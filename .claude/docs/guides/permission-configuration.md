...
permissions:
  allow:
    ...
    - write: [".claude/specs/TODO.md", ".claude/specs/state.json", ".claude/specs/**/plans/*.md"]
...
permissions:
  allow:
    - read: [".claude/specs/**/*"]
    - write: [".claude/specs/TODO.md", ".claude/specs/state.json"]
    - bash: ["date", "git"]
  deny:
    - write: [".git/**/*"]
    - bash: ["rm", "sudo"]
...
permissions:
  allow:
    - read: [".claude/specs/**/*"]
    - write: [".claude/specs/{agent_output}/**/*"]
    - bash: ["git"]
