...
The `Documentation/Research/` directory contains 7 files with inconsistent naming conventions. Four files use ALL_CAPS (DUAL_VERIFICATION.md, PROOF_LIBRARY_DESIGN.md, README.md, THEORY_COMPARISON.md), while three use lowercase-hyphenated format (deduction-theorem-necessity-research.md, noncomputable-research.md, property-based-testing-lean4.md). The lowercase-hyphenated files redundantly include "research" in their names. There are extensive references throughout the codebase (~230 occurrences) that must be updated.

## Findings

### Current File Inventory

**Documentation/Research/** (7 files):
...
Grep found ~230 references to `Documentation/Research/` across the codebase:
- README.md (project root): 12 references
- Documentation/Research/README.md: 18 internal references
...
- `Documentation/Research/RECURSIVE_SEMANTICS.md` → now at `Theories/Logos/Documentation/Research/`
- `Documentation/Research/LAYER_EXTENSIONS.md` → now at `Theories/Logos/Documentation/Research/`
- `Documentation/Research/CONCEPTUAL_ENGINEERING.md` → now at `Theories/Logos/Documentation/Research/`
- `Documentation/Research/MODAL_TEMPORAL_PROOF_SEARCH.md` → now at `Theories/Bimodal/Documentation/Research/`
...
**Theories/Logos/Documentation/Research/**:
| Current | Proposed |
|---------|----------|
...
**Theories/Bimodal/Documentation/Research/**:
| Current | Proposed |
|---------|----------|
