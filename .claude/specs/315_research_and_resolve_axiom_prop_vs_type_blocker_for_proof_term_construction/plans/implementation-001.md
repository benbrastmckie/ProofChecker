...
- `docs/user-guide/TUTORIAL.md` - Tactic tutorial section
- `docs/project-info/TACTIC_REGISTRY.md` - Tactic registry entry
...
- `docs/user-guide/ARCHITECTURE.md` - Refactor documentation
