...
- **Scope**: Refactor TODO.md to remove completed tasks (rely on git history), create SORRY_REGISTRY.md for technical debt tracking, create MAINTENANCE.md documenting workflow, integrate IMPLEMENTATION_STATUS.md (macro vision) and KNOWN_LIMITATIONS.md (obstacles) through cross-linking, reduce TODO.md from 837 to ~350 lines (58% reduction)
- **Status**: [COMPLETE]
...
- **Research Reports**:
  ...
  - [IMPLEMENTATION_STATUS.md and KNOWN_LIMITATIONS.md Integration Analysis](../reports/002-status-limitations-integration-analysis.md)
...
- [ ] IMPLEMENTATION_STATUS.md updated to reference SORRY_REGISTRY.md and TODO.md
- [ ] KNOWN_LIMITATIONS.md updated to reference MAINTENANCE.md, TODO.md, and SORRY_REGISTRY.md
- [ ] CLAUDE.md references new maintenance workflow with updated documentation index
- [ ] Documentation/ProjectInfo/README.md updated with new file links
- [ ] All cross-references validated (no broken links)
- [ ] No content duplication between TODO.md and STATUS/LIMITATIONS (cross-links only)
...
**Four-Document Integration Model**:

This plan integrates TODO.md cleanup with the existing documentation ecosystem through strategic cross-linking to avoid redundancy.

1. **TODO.md** (Active Work, ~350 lines)
   - Overview with status summary (10-15 lines)
   - Quick links to related docs (STATUS.md, LIMITATIONS.md, REGISTRY.md, MAINTENANCE.md)
   - High/Medium/Low priority tasks (active only)
   - Completion History section (git query examples)
   - Project References section

2. **SORRY_REGISTRY.md** (Technical Debt Bridge, ~100 lines) **[NEW]**
   - Active placeholders with resolution context
   - Bidirectional links to IMPLEMENTATION_STATUS.md (verification commands)
   - Bidirectional links to KNOWN_LIMITATIONS.md (blocker context)
   - Bidirectional links to TODO.md (task ownership)
   - Resolved placeholders section (optional, with git query)
   - Module-by-module organization (mirrors IMPLEMENTATION_STATUS.md)

3. **MAINTENANCE.md** (Workflow Documentation, ~200 lines) **[NEW]**
   - Related Documentation section (links to all four docs)
   - Task lifecycle (creation, active work, completion)
   - Git-based history queries (for all four docs)
   - Documentation synchronization requirements (decision tree: when to update which doc)
   - Sorry placeholder workflow
   - Priority classification guidelines
   - Effort estimation guidelines
   - Cross-reference validation workflow

4. **IMPLEMENTATION_STATUS.md** (Macro Vision, 692 lines) **[EXISTING - MINIMAL UPDATES]**
   ...
   - Cross-references to TODO.md (for actionable tasks) and SORRY_REGISTRY.md (for details)

5. **KNOWN_LIMITATIONS.md** (Obstacles & Blockers, 109 lines) **[EXISTING - MINIMAL UPDATES]**
   - Gaps requiring user awareness (Completeness infrastructure only, Automation 4/12 tactics)
   - Workarounds for current limitations
   - Architectural blockers (Aesop integration blocked)
   - Cross-references to TODO.md (for resolution tasks) and SORRY_REGISTRY.md (for technical debt)
...
1. TODO.md → Other docs: Reference for detailed status, don't duplicate content
2. SORRY_REGISTRY.md ↔ All docs: Bridge document with bidirectional links
3. IMPLEMENTATION_STATUS.md ← TODO.md: Tasks update module percentages
4. KNOWN_LIMITATIONS.md ← TODO.md: Tasks resolve gaps and remove workarounds
...
2. Update IMPLEMENTATION_STATUS.md (module %, sorry count if changed)
...
- New content: Git query examples, task lifecycle, completion workflow, synchronization decision tree
...
**Tasks**:
- [x] Create `Documentation/ProjectInfo/SORRY_REGISTRY.md` with header and metadata (file: Documentation/ProjectInfo/SORRY_REGISTRY.md)
- [x] Migrate "Active Placeholders" section from TODO.md lines 323-538 (216 lines)
- [x] Add bidirectional link structure with **Blocker**, **Resolution**, **Effort**, **Task**, and **Status** fields
- [x] Add verification commands section referencing IMPLEMENTATION_STATUS.md lines 23-39 (canonical source)
- [x] Add "Resolved Placeholders" section with git query examples
- [x] Add cross-references: → IMPLEMENTATION_STATUS.md (verification), → KNOWN_LIMITATIONS.md (blockers), → TODO.md (tasks)
- [x] Verify file structure matches research report template (report 002 lines 141-159)
...
**Tasks**:
- [x] Create `Documentation/ProjectInfo/MAINTENANCE.md` with header (file: Documentation/ProjectInfo/MAINTENANCE.md)
- [x] Add "Related Documentation" section at top with links to all four docs (TODO.md, STATUS.md, LIMITATIONS.md, REGISTRY.md)
- [x] Add "Task Lifecycle" section (adding, starting, completing tasks)
- [x] Add "Git-Based History Model" section with philosophy and benefits
- [x] Add "Completion History Queries" section with git query examples for all four docs (from research report 001 Appendix B)
- [x] Add "Documentation Synchronization" section with decision tree: when to update which document (report 002 lines 323-350)
- [x] Add "Sorry Placeholder Workflow" section (cross-reference SORRY_REGISTRY.md)
- [x] Add "Priority Classification" section (High/Medium/Low criteria)
- [x] Add "Effort Estimation" section (hour estimate guidelines)
- [x] Add "Cross-Reference Validation" section (verify bidirectional links work)
- [x] Verify file structure matches research report template (report 001 lines 702-803)
...
# Verify MAINTENANCE.md includes all four doc references
grep -q "SORRY_REGISTRY.md" Documentation/ProjectInfo/MAINTENANCE.md
grep -q "IMPLEMENTATION_STATUS.md" Documentation/ProjectInfo/MAINTENANCE.md
grep -q "KNOWN_LIMITATIONS.md" Documentation/ProjectInfo/MAINTENANCE.md

# Count sections (should be at least 10)
SECTION_COUNT=$(grep -c "^## " Documentation/ProjectInfo/MAINTENANCE.md)
[ "$SECTION_COUNT" -ge 10 ] && echo "✓ All sections present" || echo "✗ Missing sections"
```
...
**Tasks**:
- [x] Remove completed tasks from TODO.md (Tasks 1-8, 12, 15 from lines 53-280, ~150 lines) (file: TODO.md)
- [x] Remove "Progress Tracking" section (lines 697-755, 58 lines)
- [x] Remove "Completion Log" table (lines 733-755, 23 lines)
- [x] Remove "Dependency Graph" section (lines 567-694, 128 lines)
- [x] Remove "Execution Waves" section (lines 655-694, 40 lines)
- [x] Remove "Sorry Placeholder Registry" section (lines 323-538, 216 lines)
- [x] Simplify "Status Summary" section and move to Overview (lines 756-800, reduce 45 → 10-15 lines)
- [x] Add "Quick Links" section at top with SORRY_REGISTRY.md and MAINTENANCE.md
- [x] Add inline dependencies to active tasks 14, 16, 17 (format: **Blocking**: Task N, **Dependencies**: Task N)
- [x] Add "Completion History" section with git query examples
- [x] Reorganize "Notes" section into "Project References" at end (lines 824-836)
- [x] Move Task 13 from Low Priority to Medium Priority (NOTE 280)
- [x] Verify final line count ~350 lines (58% reduction from 837)
...
**Objective**: Update IMPLEMENTATION_STATUS.md, KNOWN_LIMITATIONS.md, CLAUDE.md, and README.md with new document references through minimal cross-linking additions

**Complexity**: Medium

**Tasks**:
- [x] Update IMPLEMENTATION_STATUS.md (file: Documentation/ProjectInfo/IMPLEMENTATION_STATUS.md):
  - [x] Add introduction paragraph (~line 10) with links to TODO.md and SORRY_REGISTRY.md
  - [x] Add note in "Next Steps" section (~line 670) pointing to TODO.md for prioritized tasks
  - [x] Reduce task duplication in "Next Steps" section (preserve strategic direction, remove effort estimates)
- [x] Update KNOWN_LIMITATIONS.md (file: Documentation/ProjectInfo/KNOWN_LIMITATIONS.md):
  - [x] Add introduction paragraph (~line 10) with links to TODO.md and MAINTENANCE.md
  - [x] Add footer link (~line 100) to SORRY_REGISTRY.md for technical debt tracking
- [x] Update CLAUDE.md "Project Status" section (file: CLAUDE.md):
  - [x] Update TODO.md description to "Task tracking (active work only, see git history for completed tasks)"
  - [x] Add SORRY_REGISTRY.md to documentation index (after IMPLEMENTATION_STATUS.md)
  - [x] Add MAINTENANCE.md to documentation index (after KNOWN_LIMITATIONS.md)
- [x] Update Documentation/ProjectInfo/README.md to add SORRY_REGISTRY.md and MAINTENANCE.md links (file: Documentation/ProjectInfo/README.md)
- [x] Verify all cross-references are bidirectional (A→B implies B→A)
- [x] Verify no broken links (all referenced files exist)
- [x] Verify no content duplication (cross-links only, not content migration)

**Testing**:
```bash
# Verify IMPLEMENTATION_STATUS.md references SORRY_REGISTRY.md and TODO.md
grep -q "SORRY_REGISTRY.md" Documentation/ProjectInfo/IMPLEMENTATION_STATUS.md
grep -q "TODO.md" Documentation/ProjectInfo/IMPLEMENTATION_STATUS.md

# Verify KNOWN_LIMITATIONS.md references MAINTENANCE.md, TODO.md, and SORRY_REGISTRY.md
grep -q "MAINTENANCE.md" Documentation/ProjectInfo/KNOWN_LIMITATIONS.md
grep -q "TODO.md" Documentation/ProjectInfo/KNOWN_LIMITATIONS.md
grep -q "SORRY_REGISTRY.md" Documentation/ProjectInfo/KNOWN_LIMITATIONS.md

# Verify CLAUDE.md references new workflow
grep -q "MAINTENANCE.md" CLAUDE.md || grep -q "Git-based history" CLAUDE.md
grep -q "SORRY_REGISTRY.md" CLAUDE.md
...
# Verify bidirectional linking (SORRY_REGISTRY.md → all docs)
grep -q "TODO.md" Documentation/ProjectInfo/SORRY_REGISTRY.md
grep -q "IMPLEMENTATION_STATUS.md" Documentation/ProjectInfo/SORRY_REGISTRY.md
grep -q "KNOWN_LIMITATIONS.md" Documentation/ProjectInfo/SORRY_REGISTRY.md

# Verify bidirectional linking (MAINTENANCE.md → all docs)
...
for file in Documentation/ProjectInfo/SORRY_REGISTRY.md Documentation/ProjectInfo/MAINTENANCE.md Documentation/ProjectInfo/IMPLEMENTATION_STATUS.md Documentation/ProjectInfo/KNOWN_LIMITATIONS.md; do
  test -f "$file" && echo "✓ $file exists" || echo "✗ $file missing"
done

# Verify no content duplication (STATUS.md and LIMITATIONS.md received links only)
echo "Verifying minimal updates to STATUS.md and LIMITATIONS.md..."
# Check that STATUS.md changes are small (10-15 lines max)
# Check that LIMITATIONS.md changes are small (5-10 lines max)
```
...
### Phase 5: Final Verification and Commit [COMPLETE]
dependencies: [4]
...
**Tasks**:
- [x] Run comprehensive verification (all test commands from phases 1-4)
- [x] Verify line count metrics match research estimates (TODO.md ~350, SORRY_REGISTRY.md ~100, MAINTENANCE.md ~200)
- [x] Verify all 11 NOTE tags from research report addressed
- [x] Review MAINTENANCE.md for completeness (task lifecycle, git queries, synchronization)
- [x] Review SORRY_REGISTRY.md for completeness (active placeholders, verification commands)
- [x] Review TODO.md for clarity (active work only, no history clutter)
- [x] Create git commit with comprehensive migration message (see research report lines 831-846 for template)
- [x] Verify commit message references all NOTE tags addressed
...
grep -q "TODO.md" Documentation/ProjectInfo/IMPLEMENTATION_STATUS.md && echo "✓ STATUS references TODO"
grep -q "MAINTENANCE.md" Documentation/ProjectInfo/KNOWN_LIMITATIONS.md && echo "✓ LIMITATIONS references MAINTENANCE"
grep -q "TODO.md" Documentation/ProjectInfo/KNOWN_LIMITATIONS.md && echo "✓ LIMITATIONS references TODO"
grep -q "SORRY_REGISTRY.md" Documentation/ProjectInfo/KNOWN_LIMITATIONS.md && echo "✓ LIMITATIONS references REGISTRY"
...
grep -q "IMPLEMENTATION_STATUS.md" TODO.md && echo "✓ TODO → STATUS"
grep -q "KNOWN_LIMITATIONS.md" TODO.md && echo "✓ TODO → LIMITATIONS"

# SORRY_REGISTRY.md → All docs (bidirectional bridge)
grep -q "TODO.md" Documentation/ProjectInfo/SORRY_REGISTRY.md && echo "✓ SORRY_REGISTRY → TODO"
grep -q "IMPLEMENTATION_STATUS.md" Documentation/ProjectInfo/SORRY_REGISTRY.md && echo "✓ SORRY_REGISTRY → STATUS"
grep -q "KNOWN_LIMITATIONS.md" Documentation/ProjectInfo/SORRY_REGISTRY.md && echo "✓ SORRY_REGISTRY → LIMITATIONS"

# MAINTENANCE.md → All docs
grep -q "TODO.md" Documentation/ProjectInfo/MAINTENANCE.md && echo "✓ MAINTENANCE → TODO"
grep -q "IMPLEMENTATION_STATUS.md" Documentation/ProjectInfo/MAINTENANCE.md && echo "✓ MAINTENANCE → STATUS"
grep -q "KNOWN_LIMITATIONS.md" Documentation/ProjectInfo/MAINTENANCE.md && echo "✓ MAINTENANCE → LIMITATIONS"
grep -q "SORRY_REGISTRY.md" Documentation/ProjectInfo/MAINTENANCE.md && echo "✓ MAINTENANCE → SORRY_REGISTRY"

# IMPLEMENTATION_STATUS.md → TODO.md and SORRY_REGISTRY.md
grep -q "SORRY_REGISTRY.md" Documentation/ProjectInfo/IMPLEMENTATION_STATUS.md && echo "✓ STATUS → SORRY_REGISTRY"
grep -q "TODO.md" Documentation/ProjectInfo/IMPLEMENTATION_STATUS.md && echo "✓ STATUS → TODO"

# KNOWN_LIMITATIONS.md → TODO.md, MAINTENANCE.md, and SORRY_REGISTRY.md
grep -q "MAINTENANCE.md" Documentation/ProjectInfo/KNOWN_LIMITATIONS.md && echo "✓ LIMITATIONS → MAINTENANCE"
grep -q "TODO.md" Documentation/ProjectInfo/KNOWN_LIMITATIONS.md && echo "✓ LIMITATIONS → TODO"
grep -q "SORRY_REGISTRY.md" Documentation/ProjectInfo/KNOWN_LIMITATIONS.md && echo "✓ LIMITATIONS → SORRY_REGISTRY"
...
echo "=== Synchronization Integrity ==="
# Verify SORRY_REGISTRY.md count matches verification commands
REGISTRY_COUNT=$(grep -c "^\- \*\*" Documentation/ProjectInfo/SORRY_REGISTRY.md || echo 0)
ACTUAL_COUNT=$(grep -r "sorry" Logos/**/*.lean 2>/dev/null | wc -l)
echo "REGISTRY count: $REGISTRY_COUNT, Actual count: $ACTUAL_COUNT"
[ "$REGISTRY_COUNT" -eq "$ACTUAL_COUNT" ] && echo "✓ Sorry counts synchronized" || echo "⚠ Sorry counts may differ (verify manually)"

# Verify STATUS.md "Next Steps" references TODO.md
grep -q "TODO.md" Documentation/ProjectInfo/IMPLEMENTATION_STATUS.md && echo "✓ STATUS Next Steps points to TODO"

# Verify no content duplication
echo "Verifying no content duplication..."
echo "✓ STATUS.md received links only (no sorry details migrated)"
echo "✓ LIMITATIONS.md received links only (no workarounds duplicated)"
...
- SORRY_REGISTRY.md: ~100 lines with bidirectional links
- MAINTENANCE.md: ~200 lines with four-document integration
- IMPLEMENTATION_STATUS.md: +10-15 lines (cross-reference additions only)
- KNOWN_LIMITATIONS.md: +5-10 lines (cross-reference additions only)
- All 11 NOTE tags from research report addressed
- All cross-references bidirectional and working (15+ link pairs verified)
- No broken links
- No content duplication (cross-links replace content migration)
- Sorry counts synchronized across REGISTRY.md and STATUS.md
...
2. **Documentation/ProjectInfo/MAINTENANCE.md**
   ...
   - Completion history queries section (for all four docs)
   - Documentation synchronization section (decision tree)
   ...
   - Cross-references to TODO.md, SORRY_REGISTRY.md, STATUS.md, LIMITATIONS.md
...
2. **Documentation/ProjectInfo/IMPLEMENTATION_STATUS.md**
   - Add introduction paragraph (~line 10) with links to TODO.md and SORRY_REGISTRY.md
   - Add note in "Next Steps" section (~line 670) pointing to TODO.md
   - Reduce task duplication in "Next Steps" section

3. **Documentation/ProjectInfo/KNOWN_LIMITATIONS.md**
   - Add introduction paragraph (~line 10) with links to TODO.md and MAINTENANCE.md
   - Add footer link (~line 100) to SORRY_REGISTRY.md

4. **CLAUDE.md**
   - Update "Project Status" section to reference new git-based workflow
...
**Last Updated**: 2025-12-05 (Revised: Integrated IMPLEMENTATION_STATUS.md and KNOWN_LIMITATIONS.md through four-document cross-linking model)
