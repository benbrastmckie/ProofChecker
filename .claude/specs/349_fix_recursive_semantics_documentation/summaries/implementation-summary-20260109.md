...
- `Documentation/Research/RECURSIVE_SEMANTICS.md` - Main semantic specification (all 25 [FIX] tags removed)
- `Documentation/Reference/GLOSSARY.md` - Updated with new entries:
