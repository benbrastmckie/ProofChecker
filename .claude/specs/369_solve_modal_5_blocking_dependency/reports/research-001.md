...
The sorry is properly documented in `Documentation/ProjectInfo/SORRY_REGISTRY.md`:
...
2. Moved to an `Examples/` or `Documentation/` file
...
- `Documentation/ProjectInfo/SORRY_REGISTRY.md:107-127` - Sorry documentation
