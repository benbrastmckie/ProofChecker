...
This repository presents the **Bimodal** fragment of the Logos which is of independent interest on account of being both sound and complete. The Bimodal theory also serves as a methodological testbed for Logos, capturing a fundamental relationships between time and possibility needed for systematic planning.
