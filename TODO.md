...
### 260. Investigate Claude Code CLI Argument Mechanism
**Effort**: 2 hours
**Status**: [NOT STARTED]
**Priority**: Critical
**Type**: meta
**Dependencies**: None
**Plan**: [.opencode/specs/260_investigate_claude_code_cli_argument_mechanism/plans/implementation-001.md]
**Blocking**: 261, 262, 263, 264

**Description**: Investigate how Claude Code CLI actually passes arguments from user input to agents. The current system assumes a `$ARGUMENTS` environment variable exists, but evidence shows this is incorrect. Determine the actual mechanism through empirical testing and document findings.

**Action Items**:
1. Test environment variable availability
2. Analyze user input passing mechanism
3. Compare actual behavior with documentation
4. Create research report with findings and recommendations

**Files**:
- `.opencode/agent/orchestrator.md` (references $ARGUMENTS)
- `.opencode/context/core/standards/command-argument-handling.md` (documents $ARGUMENTS)

### 261. Redesign Argument Passing Mechanism
**Effort**: 3 hours
**Status**: [NOT STARTED]
**Priority**: Critical
**Type**: meta
**Dependencies**: 260
**Plan**: [.opencode/specs/261_redesign_argument_passing_mechanism/plans/implementation-001.md]
**Blocking**: 262, 263

**Description**: Design a new argument passing mechanism that works with the actual Claude Code CLI system (as discovered in task 260). Create architectural design document and update the command-argument-handling.md standard.

**Action Items**:
1. Analyze task 260 findings
2. Design new argument passing mechanism
3. Update command-argument-handling.md standard
4. Create design document for implementation

**Files**:
- `.opencode/context/core/standards/command-argument-handling.md`

### 262. Update Orchestrator for New Argument Mechanism
**Effort**: 2 hours
**Status**: [NOT STARTED]
**Priority**: Critical
**Type**: meta
**Dependencies**: 261
**Plan**: [.opencode/specs/262_update_orchestrator_for_new_argument_mechanism/plans/implementation-001.md]
**Blocking**: 264

**Description**: Update the orchestrator agent to use the new argument passing mechanism designed in task 261. Modify Stage 1 (PreflightValidation) and Stage 3 (RegisterAndDelegate) to work with the actual Claude Code CLI system.

**Action Items**:
1. Update Stage 1 argument parsing logic
2. Update Stage 3 prompt formatting logic
3. Remove or update $ARGUMENTS references
4. Update error messages and documentation

**Files**:
- `.opencode/agent/orchestrator.md`

### 263. Update All Commands for New Argument Mechanism
**Effort**: 3 hours
**Status**: [NOT STARTED]
**Priority**: Critical
**Type**: meta
**Dependencies**: 261, 262
**Plan**: [.opencode/specs/263_update_all_commands_for_new_argument_mechanism/plans/implementation-001.md]
**Blocking**: 264

**Description**: Update all command files in `.opencode/command/` to use the new argument passing mechanism. Ensure consistency across all commands and maintain backward compatibility where possible.

**Action Items**:
1. Update task-based commands (implement, research, plan, revise)
2. Update direct commands (meta, review, todo, errors, task)
3. Update examples and documentation
4. Verify consistency with new standard
...
### 264. Test and Document Argument Passing
**Effort**: 2 hours
**Status**: [NOT STARTED]
**Priority**: Critical
**Type**: meta
**Dependencies**: 262, 263
**Plan**: [.opencode/specs/264_test_and_document_argument_passing/plans/implementation-001.md]
**Blocking**: None

**Description**: Test the new argument passing mechanism with all commands and document the results. Verify `/implement 259` works correctly (original failing case). Create comprehensive documentation for users and maintainers.
...
**Files**:
- All command files (for testing)
- `.opencode/docs/guides/argument-passing-guide.md` (to be created)
