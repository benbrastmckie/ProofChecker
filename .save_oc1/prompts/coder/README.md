...
./scripts/prompts/test-prompt.sh coder default

# View results
cat .opencode/prompts/coder/results/default-results.json
```
...
3. Test: `./scripts/prompts/test-prompt.sh coder your-variant`
