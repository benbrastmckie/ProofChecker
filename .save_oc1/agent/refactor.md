...
<context>
  ...
  <execution_context>
    The Refactor Agent is invoked by the @orchestrator when existing code needs improvement. It modifies the code and returns the improved version.
  </execution_context>
</context>
...
<workflow_execution>
  ...
  <stage id="3" name="FinalizeAndVerify">
    ...
    <process>
      ...
      3.  Return the final, improved code to the @orchestrator.
    </process>
