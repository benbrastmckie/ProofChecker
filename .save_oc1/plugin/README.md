...
Validates that General follows its defined prompt rules and execution patterns.
...
3. **Validation** - Compares actual behavior against General rules
...
5. Integrate into General workflow
