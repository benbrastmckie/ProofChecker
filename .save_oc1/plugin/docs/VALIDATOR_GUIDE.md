...
According to General prompt, the agent should:
...
# Run OpenCode task
opencode --agent general --input "Build the feature"

# Export validation report
opencode --agent general --input "export_validation_report --output_path ./reports/validation.md"
