...
#figure(
  table(
    ...
    [`Discrete`], [#ztime-only-count axioms: `prior_UZ`, `prior_SZ`, `z1`],
    // LEAN-ANCHOR-MAY-MOVE: co-reynolds-independence -- see typst/README.md
    [`Dedekind`], [#rtime-only-count axioms (Reynolds' definable-gap layer, admissible together with `Dense`'s axioms): `prior_U_gap`, `prior_S_gap`, `sep`],
    table.hline(),
  ),
