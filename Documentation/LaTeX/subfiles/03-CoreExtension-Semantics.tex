...
Let $\frame = \langle \statespace, \parthood, \temporalorder, \taskrel \rangle$ be a core frame.
\begin{align}
...
A \emph{world-history} over a core frame $\frame$ is a function $\history : X \to \worldstates$ where:
\begin{itemize}
