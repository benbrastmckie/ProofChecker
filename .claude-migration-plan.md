...
- [ ] Create implementer skill
- [ ] Create lean-research skill
- [ ] Create lean-implementation skill
- [ ] Create status-sync skill
- [ ] Create git-workflow skill
- [ ] Create task-management skill

### Phase 4: Context
- [ ] Migrate core standards to rules/
- [ ] Migrate Lean context to rules/lean4.md
- [ ] Set up CLAUDE.md imports
- [ ] Verify path matching works
